...
namespace M1
{
    public class Fornecedor
    {
        ...
        {
            List<Fornecedor> arr = new List<Fornecedor>(); //criou um obj da classe List que contem somente objetos da classe Sexo
            ...
            try
            {
                ...
                string sql = "";
                //monta o comando sql
                sql = "select * from cmbfornecedor order by descricao;";
                ...
                while (dr.Read())
                {
                    ...
                    Fornecedor objdepto = new Fornecedor();
        ...
        public void preencher()
        {
            ...
            try
            {
                ...
                string sql = "";
                //monta o comando sql
                sql = "select * from cmbfornecedor where id=" + this.id + ";";
